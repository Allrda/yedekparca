...
import CorporateSolutionsPage from './pages/CorporateSolutions';
...
export function AppContent() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col font-sans selection:bg-amber-400 selection:text-slate-950 relative">
      <Navbar 
        navigate={navigate} 
      ...
      <main className="flex-grow">
        ...
        {currentPage === 'thank-you' && <ThankYouPage navigate={navigate} />}
        {currentPage === 'privacy' && <PrivacyPolicyPage navigate={navigate} />}
        {currentPage === 'corporate' && <CorporateSolutionsPage navigate={navigate} />}
        {currentPage === '404' && <NotFoundPage navigate={navigate} />}
        {/* If page doesn't match known routes */}
        {!['home', 'detail', 'cart', 'checkout', 'admin', 'login', 'track', 'thank-you', 'privacy', 'corporate', '404'].includes(currentPage) && (
