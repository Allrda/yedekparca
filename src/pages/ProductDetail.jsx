    ...
    <div className="max-w-7xl mx-auto px-4 py-8 space-y-8">
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          "@type": "Product",
          "name": product.name,
          "image": product.image || "https://otofaik.com/favicon.svg",
          "description": `${product.vehicle || 'Renault & Dacia'} Orijinal Yedek Parça - OEM Kodu: ${product.oem}`,
          "sku": product.oem,
          "brand": {
            "@type": "Brand",
            "name": "Renault / Dacia OEM"
          },
          "offers": {
            "@type": "Offer",
            "priceCurrency": "TRY",
