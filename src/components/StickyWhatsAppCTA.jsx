...
export default function StickyWhatsAppCTA() {
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
      {/* Telefon Arama Butonu (Şık Telefon/Ahize SVG ikon) */}
      <a
        href="tel:05350755371"
        aria-label="Hızlı Telefon Ara"
        className="w-12 h-12 md:w-14 md:h-14 bg-slate-900 hover:bg-slate-800 text-amber-400 rounded-full shadow-2xl flex items-center justify-center transition-all duration-300 hover:scale-110 active:scale-95 border-2 border-amber-400/40 cursor-pointer group relative"
      >
      ...
      {/* WhatsApp Canlı Destek Butonu (Resmi WhatsApp Logo SVG) */}
      <a
        ...
        className="w-12 h-12 md:w-14 md:h-14 bg-emerald-500 hover:bg-emerald-600 text-white rounded-full shadow-2xl flex items-center justify-center transition-all duration-300 hover:scale-110 active:scale-95 border-2 border-emerald-400/40 cursor-pointer group relative"
      >
