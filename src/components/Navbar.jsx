      ...
      <div className="max-w-7xl mx-auto px-4 py-3">
        ...
        <div className="flex items-center justify-between gap-2 md:gap-6">
          ...
          <div className="flex items-center gap-2">
            ...
            {/* Header CTA: Hızlı Arama & WhatsApp */}
            <a
              href="tel:05350755371"
              className="hidden xl:flex items-center gap-1.5 text-xs font-bold text-slate-700 bg-slate-100 hover:bg-slate-200 px-3 py-2 rounded-xl transition"
            >
              <span>📞</span>
              <span>0535 075 5371</span>
            </a>

            <a
              href="https://wa.me/905350755371?text=Merhaba,%20par%C3%A7a%20sormak%20istiyorum."
              target="_blank"
              rel="noopener noreferrer"
              className="hidden lg:flex items-center gap-1.5 text-xs font-bold text-emerald-700 bg-emerald-50 hover:bg-emerald-100 px-3 py-2 rounded-xl transition border border-emerald-200"
            >
              <span>💬</span>
